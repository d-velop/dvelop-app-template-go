...
resource "aws_s3_bucket_policy" "allow_access_to_assets" {
  ...
  policy = data.aws_iam_policy_document.allow_access_to_assets.json

}

data "aws_iam_policy_document" "allow_access_to_assets" {
  statement {
...
resource "aws_s3_bucket_cors_configuration" "assets_cors_configuration" {
